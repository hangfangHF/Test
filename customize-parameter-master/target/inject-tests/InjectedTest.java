...
public class InjectedTest extends junit.framework.TestCase {
  public static junit.framework.Test suite() throws Exception {
    ...
    parameters.put("basedir","D:\\工作文件\\相关文件\\jekins\\customize-parameter-master");
    parameters.put("artifactId","customize-parameter");
    parameters.put("outputDirectory","D:\\工作文件\\相关文件\\jekins\\customize-parameter-master\\target\\classes");
    parameters.put("testOutputDirectory","D:\\工作文件\\相关文件\\jekins\\customize-parameter-master\\target\\test-classes");
